...
if __name__ == "__main__":
    ...
    parser.add_argument('--randomforest_model',default='/home/supermicro/code/AI4Sci/DLTKcat/data/model-xgl/randomforest/model7724_randomstate42_R0.7832467074983396.pkl')
    parser.add_argument('--input', default = '/home/supermicro/code/AI4Sci/DLTKcat/cvFAP/RhKshA/RhKshA_single_need_pred.csv')
    parser.add_argument('--output', default = '/home/supermicro/code/AI4Sci/DLTKcat/cvFAP/RhKshA/rm/RhKshA_rm_pred.cvs')
    parser.add_argument('--has_label', type=str, choices=['False','True'], default = 'False')
    # 预测数据csv生成的bert.pkl
    ...
    data['pred_kcat'] = 10**data['pred_log10kcat']
